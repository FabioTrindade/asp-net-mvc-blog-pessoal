...
namespace BlogPessoal.Web.Controllers
{
    public class ArtigoController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.CategoriaDeArtigoId = new SelectList(db.CategoriaDeArtigo, "Id", "Nome");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Titulo,Conteudo,DataPublicacao,CategoriaDeArtigoId,AutorId,Removido")] Artigo artigo)
        {
            ...
            ViewBag.CategoriaDeArtigoId = new SelectList(db.CategoriaDeArtigo, "Id", "Nome", artigo.CategoriaDeArtigoId);
            return View(artigo);
        }
